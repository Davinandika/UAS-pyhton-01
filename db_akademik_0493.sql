...
--
-- Host: 127.0.0.1
-- Generation Time: 26 Jan 2022 pada 16.11
...
--
-- Database: `db_akademik_0493`
--

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_students_0493`
--

CREATE TABLE `tbl_students_0493` (
  `id` int(5) NOT NULL,
...
--
-- Dumping data untuk tabel `tbl_students_0493`
--

INSERT INTO `tbl_students_0493` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indexes for table `tbl_students_0493`
--
ALTER TABLE `tbl_students_0493`
  ADD PRIMARY KEY (`id`);
COMMIT;
